...
from . import views
import face_detector.views as fdView
...
admin.site.site_header = "GAIA Thanos Admin"
admin.site.site_title = "GAIA Thanos Admin Portal"
admin.site.index_title = "Bem vindo ao portal de acesso Gaia Thanos UEL"